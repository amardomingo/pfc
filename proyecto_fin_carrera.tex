...
\lstdefinelanguage{XML}{
  ...
  morekeywords={xmlns,xsi,field,type,fieldType,copyField,analyzer,tokenizer,filter,foaf,rdf,sc,Environment,Context,Valve,name,override,value,allow},
  otherkeywords={\&, \|, \%, \}, \{}% list your attributes here
} 
