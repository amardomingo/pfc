...
\lstdefinelanguage{XML}{
  ...
  keywordstyle=\color{red},
  morekeywords={xmlns,xsi,field,type,fieldType,copyField,analyzer,tokenizer,filter}% list your attributes here
} 
...
\include{2-stateoftheart}
\include{3-enablingtechnologies}
\include{4-requirements}
\include{5-architecture}
\include{6-prototype} % Split in two part, the first one for architecture, the second in evaluation ? Or not...
\include{7-evaluation}
