...
\acrodef{SIO}{Semantically-Interlinked Online Communities}
...
\include{5-javausecase}
\include{6-gsiusecase} % Split in two part, the first one for architecture, the second in evaluation ? Or not...
