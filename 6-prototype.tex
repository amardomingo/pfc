...
\lstinputlisting[language=JavaScript, firstline=125, lastline=148]{code/prot/schema.xml}
...
\lstinputlisting[language=JavaScript, firstline=542, lastline=567]{code/prot/schema.xml}
